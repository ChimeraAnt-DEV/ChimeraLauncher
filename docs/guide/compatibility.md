...
Chimera Client targets Android 9.0 or later on ARM64 devices. Devices with more
...
Chimera Client requires the official Minecraft Bedrock Edition app from Google
