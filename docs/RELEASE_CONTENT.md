...
```json
{
  ...
  "url": "https://github.com/ChimeraAnt-DEV/ChimeraClient/releases",
  "important": false,
  "notify": true
}
```
...
`https://raw.githubusercontent.com/ChimeraAnt-DEV/ChimeraClient/main/resources/launcher/news.json`
