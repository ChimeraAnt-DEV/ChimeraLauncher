...
```json
{
  ...
  "url": "https://github.com/ChimeraAnt-DEV/ChimeraLauncher/releases",
  "important": false,
  "notify": true
}
```
...
`https://raw.githubusercontent.com/ChimeraAnt-DEV/ChimeraLauncher/main/resources/launcher/news.json`
