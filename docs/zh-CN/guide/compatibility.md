...
Chimera Client 面向 Android 9.0 或更高版本的 ARM64 设备。可用内存和存储越多，管理
多个版本、大型世界或资源包时体验越好。

## Minecraft 要求

Chimera Client 需要 Google Play 安装的正版 Minecraft Bedrock Edition。它面向合法
玩家，不提供 Minecraft 授权。
...
请从 Google Play 安装或更新官方 Minecraft，然后重新打开 Chimera Client。
