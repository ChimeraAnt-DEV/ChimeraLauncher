...
features:
  - title: 官方游戏优先
    details: Chimera Client 面向合法 Minecraft 基岩版玩家，要求设备上存在来自 Google Play 的官方 Minecraft。
  - title: 多版本隔离
...
Chimera Client 是一个开源 Android Minecraft 基岩版启动器。本文档优先讲清楚启动器本身：如何安装、准备官方 Minecraft、管理版本、启动游戏、整理玩家内容，以及如何处理兼容性问题。
