...
public final class LaunchTrace {
    public static final String EXTRA_SESSION_ID = "org.chimeramc.client.extra.LAUNCH_SESSION_ID";
    public static final String EXTRA_STARTED_ELAPSED_MS = "org.chimeramc.client.extra.LAUNCH_STARTED_ELAPSED_MS";
