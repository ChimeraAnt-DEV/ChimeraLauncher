...
public final class InstanceShortcutManager {
    public static final String ACTION_LAUNCH_INSTANCE = "org.chimeramc.client.action.LAUNCH_INSTANCE_SHORTCUT";
    public static final String EXTRA_INSTANCE_TYPE = "org.chimeramc.client.extra.SHORTCUT_INSTANCE_TYPE";
    public static final String EXTRA_INSTANCE_KEY = "org.chimeramc.client.extra.SHORTCUT_INSTANCE_KEY";
