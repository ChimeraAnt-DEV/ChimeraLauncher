...
import org.chimeramc.client.core.curseforge.CurseForgeClient;
import org.chimeramc.client.core.curseforge.models.Content;
import org.chimeramc.client.core.curseforge.models.ContentFile;
...
public class ContentDetailsActivity extends BaseActivity {
    ...
    private void loadAllFiles() {
        ...
        client.getModFiles(content.id, 0, 50, new CurseForgeClient.CurseForgeCallback<>() {
            @Override
            public void onSuccess(org.chimeramc.client.core.curseforge.models.ModFilesResponse result) {
                runOnUiThread(() -> {
            ...
            public void onError(Throwable t) {
                runOnUiThread(() -> {
                    ...
                    if (t instanceof CurseForgeClient.MissingApiKeyException) {
                        org.chimeramc.client.core.curseforge.CurseForgeKeyDialog.show(
    ...
    private void showFilesDialog(java.util.List<ContentFile> files) {
        ...
        org.chimeramc.client.ui.adapter.FileListAdapter adapter = new org.chimeramc.client.ui.adapter.FileListAdapter(file -> {
            dialog.dismiss();
