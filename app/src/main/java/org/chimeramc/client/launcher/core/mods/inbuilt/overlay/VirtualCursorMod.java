...
public class VirtualCursorMod {
    ...
    private static void setCursorVisible(boolean visible, Activity activity) {
        if (visible) {
            if (cursorView == null && activity != null) {
                ...
                cursorView.setImageResource(org.chimeramc.client.R.drawable.ic_virtual_cursor);
        ...
        switch (event.getActionMasked()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (pointerIndex >= 0) {
                    ...
                    float sensitivity = org.chimeramc.client.core.mods.inbuilt.manager.InbuiltModManager.getInstance(activity).getCursorSensitivity() / 100f;
    ...
    private static void sendClick(Activity activity, float x, float y, long time) {
        ...
        try {
            if (activity instanceof org.chimeramc.client.core.minecraft.MinecraftActivity) {
                ((org.chimeramc.client.core.minecraft.MinecraftActivity) activity).dispatchTouchEventToGame(downEvent);
            }
        ...
        try {
            if (activity instanceof org.chimeramc.client.core.minecraft.MinecraftActivity) {
                ((org.chimeramc.client.core.minecraft.MinecraftActivity) activity).dispatchTouchEventToGame(upEvent);
            }
        } catch (Exception ignored) {}
        upEvent.recycle();
    }
