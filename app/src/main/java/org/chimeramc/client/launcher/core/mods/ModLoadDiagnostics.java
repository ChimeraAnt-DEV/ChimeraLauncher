...
public final class ModLoadDiagnostics {
    ...
    public static void record(Context context, List<Record> records) {
        ...
        if (!org.chimeramc.client.util.JsonIOUtils.write(getFile(context), serialize(trimmed))) {
    ...
    public static List<Record> getAll(Context context) {
        ...
        return parse(org.chimeramc.client.util.JsonIOUtils.read(getFile(context)));
    }
