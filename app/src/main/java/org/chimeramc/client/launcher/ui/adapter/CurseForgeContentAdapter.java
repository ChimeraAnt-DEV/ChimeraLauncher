...
public class CurseForgeContentAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        org.chimeramc.client.util.PersonalizationManager pm = new org.chimeramc.client.util.PersonalizationManager(ctx);
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        void bind(final Content content, final OnContentClickListener listener) {
            ...
            new org.chimeramc.client.util.PersonalizationManager(itemView.getContext()).applyGlassToView(itemView);
