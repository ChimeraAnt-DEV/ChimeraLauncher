package org.chimeramc.client.ui.dialogs;
...
public class LogcatOverlay extends FrameLayout {
    ...
    private void copyFullLogToClipboard() {
        ...
        String fileText = org.chimeramc.client.core.minecraft.LaunchLog.readAll(getContext().getApplicationContext());
        List<String> snapshot;
        synchronized (logBuffer) { snapshot = new ArrayList<>(logBuffer); }
        if (fileText != null) {
    ...
    private void shareLogFile() {
        String content = org.chimeramc.client.core.minecraft.LaunchLog.readAll(getContext().getApplicationContext());
