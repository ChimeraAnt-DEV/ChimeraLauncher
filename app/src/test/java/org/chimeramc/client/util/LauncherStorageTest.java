...
public class LauncherStorageTest {
    ...
    public void mediaAppRootUsesPackageMediaDirectory() {
        File mediaDir = new File("/storage/emulated/0/Android/media/org.chimeramc.client");
    ...
    public void displayPathUsesAndroidMediaPackageDirectory() {
        assertEquals(
                "Android/media/org.chimeramc.client",
                LauncherStorage.buildTargetAppRootDisplayPath("org.chimeramc.client")
        );
    }

    @Test
    public void profileCacheRootUsesInternalCacheDirectoryAndVersionId() {
        File appCacheDir = new File("/data/user/0/org.chimeramc.client/cache");
